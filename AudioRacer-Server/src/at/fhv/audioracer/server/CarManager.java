...
public class CarManager {
	private final Map<Integer, GameUnit> _carList = Collections.synchronizedMap(new HashMap<Integer, GameUnit>());
	private final Map<Integer, Car> _freeCars = Collections.synchronizedMap(new HashMap<Integer, Car>());
